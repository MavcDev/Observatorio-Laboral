...
{
    public partial class foros_investigacion : System.Web.UI.Page
    {
        private String cod;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cargar_encabezado();
            cargar_foros_inestigacion();
        }

        public void cargar_foros_inestigacion()
        {
            Foro[] foros = new Foro().cargar_por_tipo("2");
            for (int i = 0; i < foros.Length;i++ )
            {
                ...
                if(foros[i].Cod_usuario.Equals(cod)){
                    ...
                    edit.PostBackUrl = "~/Paginas/editar_foro.aspx?tipo=2&fo=" + foros[i].Id + "";
