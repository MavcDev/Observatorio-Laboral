...
{
    public partial class ofertas_academico : System.Web.UI.Page
    {
        private String cod;
        ...
        {
            Oferta[] ofertas = new Oferta().cargar_por_tipo("1");
            for (int i = 0; i < ofertas.Length; i++)
            {
                ...
                if (ofertas[i].Cod_usuario.Equals(cod))
                {
                    ...
                    edit.PostBackUrl = "~/Paginas/editar_oferta.aspx?tipo=1&ofe="+ofertas[i].Id;
