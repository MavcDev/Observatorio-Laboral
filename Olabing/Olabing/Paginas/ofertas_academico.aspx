<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ofertas_academico.aspx.cs" Inherits="Olabing.Paginas.ofertas_academico" %>
    ...
    <form id="form1" runat="server">
        <div id="wrap">
                   ...
                   <div id="pad">
                        <center>
                        <br />
                        <h1>Ofertas Academicas</h1>
                        <br />
                       <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Imagenes/add.png" 
                            PostBackUrl="~/Paginas/crear_oferta.aspx?tipo=1" />
